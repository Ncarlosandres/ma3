...
<html lang="es">
    ...
    <head>
        ...
        <title>Comprobar Asistencia</title>
                        ...
                        <div>
                            <div class="form-row">
                                <div class="custom-file mb-1">
                                    ...
                                    <label for="file_asistencia" class="custom-file-label">Elija un archivo de asistencias excel</label><br/>
                                    <input type="file" name="file_asistencia" id="file" class="custom-file-input" accept=".xls,.xlsx">
                            ...
                            <div class="form-row">
                                ...
                                <button type="submit" id="submit" name="import_asistencia" class="btn btn-warning btn-block">Importar Registros</button>
           ...
           <div class="row">
               ...
               <div class="col">
                   ...
                   <?php
                        ...
                        if ( isset( $_POST["import_asistencia"] ) ) {
                            ...
                            if ( in_array( $_FILES["file_asistencia"]["type"], $allowedFileType ) ) {

                                $targetPath = 'subidas_asistencia/'.$_FILES['file_asistencia']['name'];
                                move_uploaded_file( $_FILES['file_asistencia']['tmp_name'], $targetPath );
                            ...
                            $r++ ) {
                                ...
                                if ( in_array( $fechas_excel[$r], $fechas_bd ) ) {
                                    ...
                                    echo "<tr><td>$fechas_excel[$r] esta fecha ya se encuentra cargada en la base de datos </td></tr>";
