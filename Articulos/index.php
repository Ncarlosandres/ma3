    ...
    <div class="row justify-content-center" >
       <?php
                ...
                <center>
                    <div class="form-group">
                        <input type="text" name="numero" class="form-control"
                               placeholder="Art. Nro." autofocus>
                    </div>
                    <div class="form-group">
                        <input type="text" name="descripcion" class="form-control"
                        placeholder="detalle articulo" autofocus>
                    </div>
                    <div class="form-group">
                        <input type="number" name="dias_aplicacion" class="form-control"
                        placeholder="Cantidad de dias que aplican" autofocus>
                    </div>
                    <input type="submit" class="btn btn-success btn-block" name="grabar" value="Grabar Articulos">
                </center>
                </form>
                <br/>
            </div>
        ...
        <div class="col-lg-7 fluid" style="margin-top: 20px;">
            ...
            <div class="card col2 container-fluid" style="border-radius: 15px;border: 3px solid black;padding-block: 15px;">
                <div class="container-fluid">
                    <label style="font-size: 20px;padding-inline: 15px;" for="busqueda">Numero o Descrip. Articulo</label>
